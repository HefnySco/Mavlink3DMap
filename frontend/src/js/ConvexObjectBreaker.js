...
ConvexObjectBreaker.prototype = {
	...
	/**
	 * Attached attributes to THREE.onject
	 * @param {*} p_object 
	 * @param {*} mass 
	 * @param {*} velocity 
	 ...
	 * @param {*} breakable 
	 */
	prepareBreakableObject: function ( p_object, mass, velocity, angularVelocity, breakable ) {

		// object is a Object3d (normally a Mesh), must have a BufferGeometry, and it must be convex.
		// Its material property is propagated to its children (sub-pieces)
		// mass must be > 0

		if ( ! p_object.geometry.isBufferGeometry ) {

			console.error( 'THREE.ConvexObjectBreaker.prepareBreakableObject(): Parameter object must have a BufferGeometry.' );

		}

		var userData = p_object.userData;
		userData.mass = mass;
